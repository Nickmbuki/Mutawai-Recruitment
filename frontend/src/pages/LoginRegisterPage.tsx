        ...
        <div className="section-shell grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-graphite">
              Candidate accounts are created first. Payments are only requested inside the candidate
              account when a paid service, such as professional CV generation, is selected.
            </p>
          </div>
